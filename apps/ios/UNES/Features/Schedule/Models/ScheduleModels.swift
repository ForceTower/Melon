    ...
    static let week: [[ScheduleClass]] = [
        ...
        [
            ...
            .init(start: "15:40", end: "17:20", code: "EST", title: "Estatística",
                  prof: "L. Pinheiro", color: UNESColor.amber,
